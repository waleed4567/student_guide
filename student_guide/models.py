...
class Chapter(models.Model):
    ...
    ar_title = models.CharField(_('Arabic Title'), max_length=256)
    parent = models.ForeignKey('student_guide.Chapter', on_delete=models.SET_NULL, blank=True, null=True)
...
class GuideTopic(models.Model):
    ...
    #image = models.FileField(_("Guide Entry Image"), upload_to=None, height_field=None, width_field=None, max_length=None, null=True, blank=True)
